...
Entrada: `.txt`, `.md`, `.markdown` e `.docx`. Saída: UTF-8 `.txt` e `.docx` estruturado. v1.5.1 é uma versão para desktop do Windows x64. macOS, Linux e Android não são considerados plataformas lançadas.
