...
![CleanText Studio 영어 인터페이스](assets/screenshots/v1.5.2/main-ko.png)
...
![구조화된 테이블 미리보기](assets/screenshots/v1.5.2/table-preview.png)
...
![수식 인식 미리보기](assets/screenshots/v1.5.2/math-preview.png)
...
```![소스 및 정리된 결과](assets/screenshots/v1.5.2/cleaning-before-after.png)
...
![어두운 테마와 둥근 표면](assets/screenshots/v1.5.2/rounded-ui-details.png)
...
![AI 구성](assets/screenshots/v1.5.2/ai-settings.png)
