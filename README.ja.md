...
![CleanText Studio 英語インターフェース](assets/screenshots/v1.5.2/01-main-light.png)
...
![構造化テーブルのプレビュー](assets/screenshots/v1.5.2/05-table-export.png)
...
![数式を意識したプレビュー](assets/screenshots/v1.5.2/06-word-export.png)
...
![ソースとクリーンな結果](assets/screenshots/v1.5.2/03-before-after-light.png)
...
![ダークテーマと丸い表面](assets/screenshots/v1.5.2/07-settings.png)
...
![AI 構成](assets/screenshots/v1.5.2/07-settings.png)
