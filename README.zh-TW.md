...
![CleanText Studio 英文介面](assets/screenshots/v1.5.2/main-zh-tw.png)
...
![結構化表預覽](assets/screenshots/v1.5.2/table-preview.png)
...
![公式感知預覽](assets/screenshots/v1.5.2/math-preview.png)
...
```![來源與清理結果](assets/screenshots/v1.5.2/cleaning-before-after.png)
...
![深色主題和圓形表面](assets/screenshots/v1.5.2/rounded-ui-details.png)
