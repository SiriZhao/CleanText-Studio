...
![CleanText Studio Английский интерфейс](assets/screenshots/v1.5.2/main-ru.png)
...
![Предварительный просмотр структурированной таблицы](assets/screenshots/v1.5.2/table-preview.png)
...
![Предварительный просмотр с учетом формул](assets/screenshots/v1.5.2/math-preview.png)
...
```![Источник и очищенный результат](assets/screenshots/v1.5.2/cleaning-before-after.png)
...
![Темная тема и закругленные поверхности](assets/screenshots/v1.5.2/rounded-ui-details.png)
...
![Конфигурация AI](assets/screenshots/v1.5.2/ai-settings.png)
