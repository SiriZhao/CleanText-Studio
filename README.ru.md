...
> **Текущая версия: v1.5.2 · Windows x64 · по умолчанию — сначала локальный**

<p align="center">
  <a href="https://github.com/SiriZhao/CleanText-Studio/releases/download/v1.5.2/CleanText-Studio-v1.5.2-Windows-x64-Setup.exe"><strong>Загрузить установщик</strong></a> ·
  <a href="https://github.com/SiriZhao/CleanText-Studio/releases/download/v1.5.2/CleanText-Studio-v1.5.2-Windows-x64-Portable.zip"><strong>Загрузить портативный ZIP</strong></a> ·
  <a href="https://github.com/SiriZhao/CleanText-Studio/releases/download/v1.5.2/SHA256SUMS.txt">SHA256 контрольные суммы</a>
</p>

![CleanText Studio Английский интерфейс](assets/screenshots/v1.5.2/01-main-light.png)
...
CleanText Studio v1.5.2 выпущен для **Windows x64**. Выберите установщик для обычной индивидуальной установки или выберите переносной ZIP-файл, если вы предпочитаете запускать из извлеченной папки. Ни один из пакетов не требует отдельной установки Python.

| Пакет | Использование по назначению | Скачать |
| --- | --- | --- |
| Настройка | Поддержка установки, входа в меню «Пуск» и удаления | [CleanText-Studio-v1.5.2-Windows-x64-Setup.exe](https://github.com/SiriZhao/CleanText-Studio/releases/download/v1.5.2/CleanText-Studio-v1.5.2-Windows-x64-Setup.exe) |
| Портативный | Запустить после распаковки ZIP; без установки | [CleanText-Studio-v1.5.2-Windows-x64-Portable.zip](https://github.com/SiriZhao/CleanText-Studio/releases/download/v1.5.2/CleanText-Studio-v1.5.2-Windows-x64-Portable.zip) |
| Проверка | Проверьте загруженный пакет | [SHA256SUMS.txt](https://github.com/SiriZhao/CleanText-Studio/releases/download/v1.5.2/SHA256SUMS.txt) |

Страница выпуска является источником достоверной информации о доступных файлах: [CleanText Studio v1.5.2](https://github.com/SiriZhao/CleanText-Studio/releases/tag/v1.5.2).
...
![Предварительный просмотр структурированной таблицы](assets/screenshots/v1.5.2/05-table-export.png)
...
![Предварительный просмотр с учетом формул](assets/screenshots/v1.5.2/06-word-export.png)
...
![Источник и очищенный результат](assets/screenshots/v1.5.2/03-before-after-light.png)
...
![Темная тема и закругленные поверхности](assets/screenshots/v1.5.2/07-settings.png)
...
![Конфигурация AI](assets/screenshots/v1.5.2/07-settings.png)
