...
datas = collect_data_files('emoji') + collect_data_files('keyring') + [('assets/icon.png', 'assets'), ('assets/icons/*.svg', 'assets/icons'), ('LICENSE', '.'), ('THIRD_PARTY_LICENSES.md', '.'), ('src/cleantext_studio/i18n/translations/*.json', 'cleantext_studio/i18n/translations'), ('src/cleantext_studio/llm/prompts/*.txt', 'cleantext_studio/llm/prompts')]
