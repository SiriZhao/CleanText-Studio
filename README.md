...
CleanText Studio v1.0.1 是一款完全离线、本地优先的 Windows 文本格式清洗与 Word 排版工具。支持粘贴或导入 TXT、Markdown、DOCX，清理 Markdown、Emoji、装饰符号和碎片换行，并导出 TXT 或 DOCX。

![v1.0.1 主界面](assets/screenshots/main-v1.0.1.png)
